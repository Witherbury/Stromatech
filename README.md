# Stromatech
A repository for all the projects undertaken by Stromatech. Projects that are usually related to genetics, inheritance, biotechnology, agriculture and botany.
Coding backed by calculated experiments will never fail. Growing plants, observing them, noting down their traits, studying their characteristics and working towards generating more effective biological features.
...
![DNA-Sequencing](https://user-images.githubusercontent.com/94278049/144044037-d817db55-fa5f-4244-a6e3-2341e6affea7.jpeg)

# Sanger's Method
This was the first ever method proposed for sequencing genes. Developed by and named after Nobel Prize winning scientist Frederick Sanger, this scientific accomplishment changed the face of biotech.\

The DNA to be seauenced is prepared in a single strand. In the presence of the 4 deoxyribonucleic triphosphates A, G, C and T, the polymerase extends the primer by adding the complementary dNTP to the strand of this template DNA. To determine which nucleotide is incorporated into this chain of nucleotides, a simple test is performed. Four dioxynucleotide phosphates, namely ddATP, ddCTP and ddTTP and ddGTP. They are labelled with fluorescent dye and are used to terminate the synthesis reaction.\

A ddNTP has an oxygen removed from the ribonucleotide and therfore cannot form a bond with the next nucleotide, unlike dNTPs.\
...
Al in all, this sequencing technique has 6 steps. \
